					...
					<div class="my_profile">
						<div class="left_avatar">
							<div style="width: 91%; height: 91%; background-color: #fff; border-radius: 100%; padding: 3px; margin-top: 1px; margin-left: 1px;">
								<img src="<c:url value="/resources/images/avatar.jpg"/>" style="width: 100%; height: 100%; border-radius: 100%;">
							</div>
						</div>
						<div class="avatar_item1">
							<p style="font-weight: bold; font-size: 1.25rem; margin-top: 0.7rem">${username}</p>
						</div>
				...
				<div class="header_inner">
					...
					<div class="right_side">
						<button class="upload_btn">Upload</button>
                        	...
                        	<a href="#" class="avatar">
                        		<img src="<c:url value="/resources/images/avatar.jpg"/>" class="avatar-img">
                        	</a>
					</div>
				</div>
			</div>
						...
						<div class="post">
							<div class="post-header">
                                ...
                                <div style="width: 150px; font-size: 13px; position: relative; top: -6px; left: 15px;">
									<p style="color: #666; height: 0px;">8 giờ trước</p>
								</div>
							</div>
							<div class="caption">
								<p>Something interesting ...</p>
							</div>
							<img src="<c:url value="/resources/images/post-image-1.jpg"/>" style="width: 100%;">
							<div class="post-below" style="padding: 0.75rem 1rem;">
								...
								<div style="margin: 8px 0px 15px 10px;">
									<p style="color: #666; letter-spacing: 0.3px;">Liked by <strong>George</strong> and <strong>209 Others</strong></p>
								</div>
